      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <TextField
            ...
            onChange={(e) => {
              ...
              // Every style recommends the same guitar+piano+drums set now --
              // explicit instruction: bass/lead/pad/vocal shouldn't get
              // added to a fresh arrangement at all, from any style pick,
              // matching DEFAULT_AI_BAND_SELECTION in aiBandEngine.js.
              const recs = {
                pop: { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
                rock: { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
                jazz: { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
                cinematic: { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
                "lo-fi": { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
                acoustic: { bass: false, piano: true, rhythm: true, drums: true, lead: false, pad: false, vocal: false },
              };
